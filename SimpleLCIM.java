...
public class SimpleLCIM{
     ...
     */
        ...
        com.enzochen.LCIM.AlgoLCIM.OrderType TOTAL_ORDER = com.enzochen.LCIM.AlgoLCIM.OrderType.ascendingSupport;
        ...
        public void runAlgorithm(String input, String output, double minUtility, double maxcost, double minsupp) throws IOException {
            ...
            if(com.enzochen.LCIM.AlgoLCIM.OrderType.ascendingCost.equals(TOTAL_ORDER) || com.enzochen.LCIM.AlgoLCIM.OrderType.descendingCost.equals(TOTAL_ORDER)) {
            ...
            // to create a map to store that information
            if(com.enzochen.LCIM.AlgoLCIM.OrderType.ascendingLowerBound.equals(TOTAL_ORDER) || com.enzochen.LCIM.AlgoLCIM.OrderType.descendingLowerBound.equals(TOTAL_ORDER)) {
            ...
            if(DEBUG) {
                ...
                for(Map.Entry<Integer, Integer> entry : mapItemToSupport.entrySet()) {
...
//		}
            ...
            try {
                ...
                while ((thisLine = myInput.readLine()) != null) {
                    ...
                    List<com.enzochen.LCIM.AlgoLCIM.Pair> revisedTransaction = new ArrayList<com.enzochen.LCIM.AlgoLCIM.Pair>();
                    ...
                    for(int i=0; i <items.length; i++){
                        ...
                        if(support >= minsupRelative){
                            ...
                            com.enzochen.LCIM.AlgoLCIM.Pair pair = new com.enzochen.LCIM.AlgoLCIM.Pair();
...
//					}});
                    ...
                    for(int i = 0; i< revisedTransaction.size(); i++){
                        com.enzochen.LCIM.AlgoLCIM.Pair pair =  revisedTransaction.get(i);
                        ...
                        if(MATRIX_SUPPORT_PRUNING) {
                            ...
                            for(int j = 0; j< revisedTransaction.size(); j++){
                                if(j!=i) {
                                    com.enzochen.LCIM.AlgoLCIM.Pair pairAfter = revisedTransaction.get(j);
            ...
            for(Map.Entry<Integer, CostList> entry : mapItemToCostList.entrySet()) {
        ...
        private int compareItems(int item1, int item2) {
            ...
            if(com.enzochen.LCIM.AlgoLCIM.OrderType.ascendingSupport.equals(TOTAL_ORDER)) {
            ...
            }else if(com.enzochen.LCIM.AlgoLCIM.OrderType.descendingSupport.equals(TOTAL_ORDER)) {
            ...
            }else if(com.enzochen.LCIM.AlgoLCIM.OrderType.ascendingCost.equals(TOTAL_ORDER)) {
                int compare = (int)( mapItemToCost.get(item1) - mapItemToCost.get(item2));
                return (compare == 0)? item1 - item2 :  compare;

                // if we use the total order of descending support of items
            }else if(com.enzochen.LCIM.AlgoLCIM.OrderType.descendingCost.equals(TOTAL_ORDER)) {
            ...
            }else if(com.enzochen.LCIM.AlgoLCIM.OrderType.ascendingLowerBound.equals(TOTAL_ORDER)) {
            ...
            }else if(com.enzochen.LCIM.AlgoLCIM.OrderType.descendingLowerBound.equals(TOTAL_ORDER)) {
...
//		}
        ...
        public void printStats() throws IOException {
            ...
            if(PRINT_MATRIX_SUPPORT_SIZE) {
                ...
                for(Map.Entry<Integer, Map<Integer, Long>> entry : mapMatrixSupport.entrySet()) {
